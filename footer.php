...
?>
	...
	<footer id="colophon" class="bg-zinc-100 py-6 md:py-10">
		
		<div class="insert-width"> <!--footer-wrap -->

			<div class="flex flex-wrap space-y-6 mb-4">

				<div class="w-full md:w-3/5 flex flex-col space-y-5 md:pr-8 lg:pr-10">
					<a class="flex items-center group" href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<!-- Logo icon -->
			...
			<?php
				wp_nav_menu(array(
					...
					'menu_class'     => 'insert-h-scroll space-x-4',
				));
			?>
			<!-- /Menu footer container -->
			</div>
			...
			<div class="site-info">
				...
				<p>&copy; <?php echo esc_html( date('Y') ); ?> <?php bloginfo('name'); ?> - All rights reserved.

				<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'pehtheme-wp' ) ); ?>">
					<?php
					/* translators: %s: CMS name, i.e. WordPress. */
					printf( esc_html__( 'Proudly powered by %s', 'pehtheme-wp' ), 'WordPress' );
					?>
				</a>
				<span class="sep"> | </span>
					<?php
					/* translators: 1: Theme name, 2: Theme author. */
					printf( esc_html__( 'Theme: %1$s by %2$s.', 'pehtheme-wp' ), 'pehtheme-wp', '<a href="https://insertapps.com/">InsertApps</a>' );
					?>
				</p>
			</div><!-- /site-info -->
