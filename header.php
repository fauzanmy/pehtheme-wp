			...
			<div id="mastwrap" class="insert-width flex flex-col"> <!-- mastwrap -->
				...
				<div id="site-branding" class="flex items-center"><!-- site-branding -->
					...
					<div class="flex items-center"><!-- left burger-logo -->
						...
						<button class="flex items-center space-x-2 rounded-full border py-1 pr-[5px] pl-3 group bg-zinc-100 hover:bg-zinc-200 toggle-button" data-target="site-navigation">
				...
				<nav id="site-navigation" class="primary-menu block mt-3 close">
